...
// Описание глобального критерия кейса
...
// Каталог фит-критериев, используемый сидером для сопоставления с базой
...
// Каталог глобальных критериев кейса
...
// Описание фит-вопросов с перечнем критериев
...
export const fitQuestionReferences = fitQuestionSeeds.map((question) => ({
  key: question.key,
