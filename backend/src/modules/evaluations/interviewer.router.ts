  ...
  try {
    const result = await evaluationWorkflowService.submitInterviewForm(
      ...
      email,
      {
        ...
        fitCriteria: Array.isArray(fitCriteria) ? fitCriteria : undefined,
        caseCriteria: Array.isArray(caseCriteria) ? caseCriteria : undefined,
        ...
        overallImpression: typeof overallImpression === 'string' ? overallImpression : undefined,
        offerRecommendation: typeof offerRecommendation === 'string' ? offerRecommendation : undefined,
        followUpPlan: typeof followUpPlan === 'string' ? followUpPlan : undefined
      }
    );
    res.json(result);
  } catch (error) {
