...
const OFFER_OPTIONS: Array<{ value: OfferRecommendationValue; label: string }> = [
  { value: 'yes_priority', label: 'Yes, priority offer' },
  { value: 'yes_strong', label: 'Yes, strong offer' },
  { value: 'yes_keep_warm', label: 'Yes, keep warm' },
...
export const InterviewerScreen = () => {
  ...
  const renderDetail = () => {
    ...
    const caseCriteria: CriterionDefinition[] = selectedAssignment.caseFolder?.evaluationCriteria ?? [];
        ...
        <div className={styles.detailHeader}>
          <div>
            ...
            <div className={styles.detailMeta}>
              <span>Assigned {formatDateTime(selectedAssignment.invitationSentAt)}</span>
        ...
        <div className={styles.detailColumns}>
          <aside className={styles.infoColumn}>
            <div className={styles.infoCard}>
              ...
              {resumeLink}
              {candidate?.city && <p>Location: {candidate.city}</p>}
            ...
            >
              ...
              <section className={styles.formSection}>
                <header className={styles.sectionHeader}>
                  ...
                  <p>Rate the candidate against the behavioral criteria and summarise key moments.</p>
                </header>
                {fitCriteria.length ? (
                  ...
                  <p className={styles.placeholderText}>No behavioral criteria are configured.</p>
                )}
                <div className={styles.formRow}>
                  <label htmlFor="fitScore">Overall behavioral score</label>
                  <select
                    id="fitScore"
                ...
                <div className={styles.formRow}>
                  <label htmlFor="fitNotes">Behavioral notes</label>
                  <textarea
                    id="fitNotes"
                    rows={4}
              ...
              <section className={styles.formSection}>
                <header className={styles.sectionHeader}>
                  ...
                  <p>Assess structured thinking, analytics, and communication across the case.</p>
                </header>
                {caseCriteria.length ? (
                  <div className={styles.criteriaGrid}>
              ...
              <section className={styles.formSection}>
                ...
                <div className={styles.formRow}>
                  <label htmlFor="issuesToTest">Topics to probe next interview</label>
                  <textarea
                    id="issuesToTest"
                    rows={3}
