...
type OutcomeTone = 'offer' | 'progress' | 'reject' | 'pending';
    ...
    return (
      <ul className={styles.list}>
        {assignments.map((assignment) => {
          ...
          const { label: outcomeLabel, tone: outcomeTone } = resolveOutcome(assignment.decision ?? null);
          const outcomeClass =
            outcomeTone === 'offer'
              ? styles.outcomePillOffer
              : outcomeTone === 'progress'
          ...
          return (
            ...
            >
              ...
              <div className={styles.listItemOutcomeRow}>
                <span className={`${styles.outcomePill} ${outcomeClass}`}>{outcomeLabel}</span>
              </div>
            </li>
          );
        })}
