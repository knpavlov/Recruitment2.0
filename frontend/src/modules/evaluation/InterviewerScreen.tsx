...
export const InterviewerScreen = () => {
  ...
  const renderDetail = () => {
    ...
    const detailMetaItems = [
      targetOfficeLabel ? `Target office: ${targetOfficeLabel}` : null,
      targetRoleLabel ? `Target role: ${targetRoleLabel}` : null
          ...
          <div>
            ...
            {detailMetaItems.length > 0 && (
              <div className={styles.detailMeta}>
                {detailMetaItems.map((entry) => (
                  <span key={entry} className={styles.detailMetaItem}>
                    {entry}
                  </span>
                ))}
              </div>
        ...
        <div className={styles.detailColumns}>
          ...
          <div className={styles.formColumn}>
            ...
            >
              ...
              <section className={styles.formSection}>
                <header className={styles.sectionHeader}>
                  <h3>Interest level notes</h3>
                </header>
                <div className={styles.formRow}>
                  <label className={styles.srOnly} htmlFor="interestNotes">
                    Interest level notes
                  </label>
                  <textarea
                    id="interestNotes"
                    rows={3}
              ...
              <section className={styles.formSection}>
                ...
                <div className={styles.formRow}>
                  <label className={styles.srOnly} htmlFor="issuesToTest">
                    Issues to Test in Next Interview
                  </label>
                  <textarea
                    id="issuesToTest"
                    rows={3}
