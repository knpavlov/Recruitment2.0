...
export interface EvaluationTableRow {
  ...
  decisionVariant: DecisionOption | null;
      ...
      <table className={styles.table}>
        ...
        <tbody>
          {rows.map((row) => {
            ...
            const decisionClasses = [styles.actionButton, styles.decisionButton];
            if (row.decisionVariant === 'offer') {
              decisionClasses.push(styles.decisionOffer);
            } else if (row.decisionVariant === 'progress') {
              decisionClasses.push(styles.decisionProgress);
            } else if (row.decisionVariant === 'reject') {
              decisionClasses.push(styles.decisionReject);
            }
                ...
                <td className={styles.actionsCell}>
                  <div className={styles.actionsRow}>
                    ...
                    <div className={styles.buttonWithMenu}>
                      <button
                        type="button"
                        className={decisionClasses.join(' ')}
