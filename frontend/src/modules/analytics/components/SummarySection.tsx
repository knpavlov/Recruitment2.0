...
const PERIOD_LABELS: Record<SummaryPeriod, string> = {
  rolling_3: 'Rolling 3-month average',
  fytd: 'Fiscal year to date',
  rolling_12: 'Rolling 12-month average'
};
...
export const SummarySection = ({
  ...
  return (
    <section className={styles.sectionCard}>
      ...
      {loading ? <div className={styles.loadingLabel}>Loading summary metrics…</div> : null}

      {!loading && !error && metrics ? (
        <div className={styles.cardsGrid}>
          <article className={styles.metricCard}>
            <h3 className={styles.metricTitle}>Female share among candidates</h3>
