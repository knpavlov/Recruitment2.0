    ...
    <section className={styles.sectionCard}>
      <header className={styles.sectionHeader}>
        <div>
          ...
          <p className={styles.metricDetails}>Conversion and activity trends for the selected aggregation window</p>
        </div>
      ...
      {loading ? <div className={styles.loadingLabel}>Rendering chart…</div> : null}
