...
import { sanitizeInterviewerName } from '../utils/interviewerName';
            ...
            {topRows.map((item) => {
              ...
              return (
                <div key={item.id} className={styles.interviewerMatrixRow}>
                  <div className={styles.matrixPrimaryCell}>
                    <div className={styles.matrixIdentity}>
                      <span className={styles.matrixName}>{sanitizeInterviewerName(item.name)}</span>
                      {item.role ? <span className={styles.roleBadge}>{item.role}</span> : null}
                    </div>
                    <div className={styles.matrixBarRow}>
