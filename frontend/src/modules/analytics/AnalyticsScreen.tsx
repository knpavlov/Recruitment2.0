...
export const AnalyticsScreen = () => {
  ...
  const [interviewerGroupBy, setInterviewerGroupBy] = useState<TimelineGrouping>('month');
  ...
  const interviewerState = useAnalyticsInterviewers(interviewerPeriod, {
    ...
    groupBy: interviewerGroupBy,
    from: interviewerFrom,
    to: interviewerTo
  });

  const handleInterviewerPeriodChange = useCallback((value: InterviewerPeriod) => {
    setInterviewerPeriod(value);
    setInterviewerFrom(undefined);
    setInterviewerTo(undefined);
  }, []);
  ...
  return (
    <div className={styles.screen}>
      ...
      <InterviewerSection
        period={interviewerPeriod}
        onPeriodChange={handleInterviewerPeriodChange}
      ...
      <InterviewerGraphSection
        ...
        onPeriodChange={handleInterviewerPeriodChange}
        groupBy={interviewerGroupBy}
        onGroupByChange={setInterviewerGroupBy}
        from={interviewerFrom}
        to={interviewerTo}
